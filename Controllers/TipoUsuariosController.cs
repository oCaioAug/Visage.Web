...
namespace Visage.Web.Controllers
{
    public class TipoUsuariosController : Controller
    {
        private readonly VisageContext _context;

        public TipoUsuariosController(VisageContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Tipo")] TipoUsuario tipoUsuario)
        {
